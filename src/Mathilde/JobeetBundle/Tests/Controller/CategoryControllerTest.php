...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testShow()
    {
        ...
        $categories = $this->em->getRepository('MathildeJobeetBundle:Category')->getWithJobs();
        ...
        foreach($categories as $category) {
            ...
            $this->assertEquals('MathildeJobeetBundleControllerCategoryController::showAction', $client->getRequest()->attributes->get('_controller'));
            $this->assertEquals($category->getSlug(), $client->getRequest()->attributes->get('slug'));
 
            $jobs_no = $this->em->getRepository('MathildeJobeetBundle:Job')->countActiveJobs($category->getId());
