...
class JobController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        foreach($categories as $category) {
            $category->setActiveJobs($em->getRepository('MathildeJobeetBundle:Job')->getActiveJobs($category->getId(), 10));
        }
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('mathilde_job_show', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('mathilde_job_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('mathilde_job_delete', array('id' => $id)))
            ->setMethod('DELETE')
