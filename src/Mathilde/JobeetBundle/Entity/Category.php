...
class Category
{
     ...
     * Add jobs
     *
     * @param \Mathilde\JobeetBundle\Entity\Job $jobs
     * @return Category
     */
     ...
     * Add affiliates
     *
     * @param \Mathilde\JobeetBundle\Entity\Affiliate $affiliates
     * @return Category
     */
	 ...
	 *
	 * @return String : the Category's name or an empty string
	 */
